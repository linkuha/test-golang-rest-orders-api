...
ALTER TABLE user_order_products ADD CONSTRAINT FK_user_order_products-order_id
    FOREIGN KEY (order_id) REFERENCES user_orders(id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE;
ALTER TABLE user_order_products ADD CONSTRAINT FK_user_order_products-product_id
